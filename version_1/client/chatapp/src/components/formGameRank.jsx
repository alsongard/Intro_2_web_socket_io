...
export default function FormGameRank()
{
    ...
    // const [displayGameRank, setDisplayGameRank] = useState(false);
    // if (gameData.length > 1)
    // {
    //     console.log("greater than 1");
    //     // setDisplayGameRank(true);
    // }
    ...
    return (
        <div className=" w-[1200px] mx-auto mt-8">
            ...
            <div className="bg-slate-300 w-1/2 mx-auto rounded-md py-[15px] px-[10px] mt-[30px] flex flex-col gap-y-2.5"> 
                {
                    gameData.length >= 1 && 
                    (
